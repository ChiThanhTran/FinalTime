...
export default function UpdateAssignment() {
    ...
    useEffect(() => {
        fetch(`https://rookiesgroup4.azurewebsites.net/getassignment/${Id}`, {
            ...
            .then(function (json) {
                console.log(json.assignmentState);
                setAssState(json.assignmentState);
            })
    }, [Id, token]);
    //Modal User
    ...
    const onFinish = (fieldsValue) => {
        ...
        if (ngaynhap > today - 1) {
            if (Nspace.trim().length !== 0) {
                axios({
                    method: 'put',
                    url: `https://rookiesgroup4.azurewebsites.net/updateassignment/${Id}`,
                    data: {
                ...
                <div className="content">
                    ...
                    >
                        <Form name="complex-form" form={form} onFinish={onFinish} {...formItemLayout} labelAlign="left" >
                            ...
                            <Form.Item label="User" style={{ marginBottom: 20 }} 
                            ...
                            <Form.Item label="Asset" style={{ marginBottom: 20 }} 
